...
description: >-
  ...
  via playwright-cli. Use when driving a browser from the CLI, generating or
  running Playwright tests, mocking requests, tracing, recording video, managing
  cookies or storage state, inspecting element attributes, or attaching
  screenshots and videos to pull requests.
---
