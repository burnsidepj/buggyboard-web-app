...
1. **Read the constitution** (`specs/constitution.md`) and the specs under `specs/` before implementing. Use at least:
   ...
   - `specs/engineering/development-process.md` – spec-first, feature-by-feature, Playwright tests with each feature, pause for review
   - `specs/engineering/test-automation-patterns.md` – tests with every feature, POM, atomic tests, Arrange-Act-Assert
...
3. **Implement Playwright tests** covering the feature’s new behavior in the same delivery. See `specs/engineering/test-automation-patterns.md`.
